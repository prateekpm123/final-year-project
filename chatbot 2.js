//////////////////   Questions  ///////////////////////
var list = ["What section is your complaint about", "Select a category",
    "Now write a detailed description of your complaint", "Do you wanna show your name or not", " THANK YOU !!!"
];
...
var answer2 = [
    ...
    ["Exam Time tables", "Question Papers", "Paper Re Evaluation", "Results"],
    [],
    ['yes', 'no'],
    []
];
...
function buttonClickCounter() {
    ...
    if (count == 2) {
        ...
        let gapgone = document.getElementById('chatboxspace1');
        gapgone.style.height = "10px";
    } else {
        let inputfield2 = document.getElementById('inputbox2');
    ...
    if (count == 4) {
        ...
        newbutton.type = "button";
        homelink.appendChild(newbutton);
        test8.appendChild(homelink);
    } else {}
...
function getTheInput(e, count) {
    if (e.type === 'keypress') {
        ...
        if (e.which == 13 || e.keycode == 13) {
            // let inputdata = [];
            alert('lkjas;lkfjsa;j');
            inputdata = document.getElementById('inputbox2').value;
            counter++;
            console.log(counter);
            counter++;
...
let input = document.getElementById("inputbox2");
